...
pub(crate) const BUILTIN_SLASH_COMMANDS: &[SlashCommandSpec] = &[
    ...
    SlashCommandSpec {
        name: "allow-all",
        aliases: &["yolo"],
        description: "Enable or disable session-local YOLO permissions",
        argument_hint: Some("on|off"),
        source: SlashCommandSource::Local,
        execution: SlashCommandExecution::TuiLocal(TuiLocalSlashCommand::AllowAll),
        feedback: SlashCommandFeedback::SUMMARY_HIDDEN_DEFERRED,
        hidden: false,
        source_label: None,
    },
    SlashCommandSpec {
    ...
    SlashCommandSpec {
        ...
        description: "Show or edit active permission allow/deny rules",
        argument_hint: None,
        source: SlashCommandSource::Local,
